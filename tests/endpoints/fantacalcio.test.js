...
const mockPicks = [
  { pick_type: 'captain', player_name: 'Lautaro', team_name: 'Inter', role: 'ATT', reasoning: 'Top form', tier: 'free', confidence: 90, expected_points: 12, ownership_pct: 45, rank: 1 },
  { pick_type: 'captain', player_name: 'Vlahovic', team_name: 'Juventus', role: 'ATT', reasoning: 'Pen taker', tier: 'free', confidence: 80, expected_points: 10, ownership_pct: 30, rank: 2 },
  { pick_type: 'differential', player_name: 'Lookman', team_name: 'Atalanta', role: 'ATT', reasoning: 'Low owned', tier: 'pro', confidence: 75, expected_points: 9, ownership_pct: 8, rank: 1 },
  { pick_type: 'buy', player_name: 'Kean', team_name: 'Fiorentina', role: 'ATT', reasoning: 'Rising form', tier: 'vip', confidence: 70, expected_points: 8, ownership_pct: 12, rank: 1 },
  { pick_type: 'sell', player_name: 'Immobile', team_name: 'Lazio', role: 'ATT', reasoning: 'Injured', tier: 'vip', confidence: 85, expected_points: 3, ownership_pct: 40, rank: 1 },
];
