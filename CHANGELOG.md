...
- **CLAUDE.md cleanup** — Rimossi contenuti non utili: sezione Copilot Agent Team (già in `.github/copilot-instructions.md`), Environment Variables (ridondante con `.env.example`), Workflow Orchestration, Task Management, Working Style, Code Quality Principles, Zero Tolerance Policy, Debugging Process (tutte istruzioni comportamentali generiche per AI, non informazioni specifiche del progetto).
